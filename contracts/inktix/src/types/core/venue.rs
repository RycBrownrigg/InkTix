...
pub enum VenueBenefit {
    FreeParking,
    ConcessionDiscounts(u8),
    MerchandiseDiscounts(u8),
    PrioritySeating,
    VIPAccess,
    MeetAndGreetAccess,
    ExclusiveEvents,
